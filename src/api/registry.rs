...
pub type RegistryIntoIter<I> = Map<
	Zip<IdTableIter<I, I, IntoIter<I>>, IdTableIter<I, Identifier, IntoIter<Identifier>>>,
	fn(((Id<I>, I), (Id<I>, Identifier))) -> (Id<I>, Identifier, I),
>;
pub type RegistryIter<'a, I> = Map<
	Zip<IdTableIter<I, &'a I, Iter<'a, I>>, IdTableIter<I, &'a Identifier, Iter<'a, Identifier>>>,
	fn(((Id<I>, &'a I), (Id<I>, &'a Identifier))) -> (Id<I>, &'a Identifier, &'a I),
>;
