...
impl Debug {
    ...
    pub fn log_event(&mut self, start: Instant) {
        self.tick_event_times.push(start.elapsed());
    }

    pub fn log_tick(&mut self, start: Instant) {
        self.tick_times.push(start.elapsed());
    }

    pub fn log_draw(&mut self, start: Instant) {
        self.draw_times.push(start.elapsed());
    }
