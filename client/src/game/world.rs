...
use rustaria::world::chunk::{Chunk, CHUNK_SIZE, CHUNK_SIZE_F32};
use rustaria::world::{ClientBoundWorldPacket, ServerBoundWorldPacket, World};
...
impl ClientWorld {
    ...
    pub fn tick_client(
        ...
        let rect = Rect::new(pos.to_point(), size2(0.0, 0.0))
            ...
            .scale(1.0 / CHUNK_SIZE_F32, 1.0 / CHUNK_SIZE_F32).round_out();
